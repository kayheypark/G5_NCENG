...
<section class="page-header" style="background-image: url(<?php echo(G5_THEME_PUBLIC_URL."/vendor")?>/images/backgrounds/page-header-contact.jpg);">
    <div class="container">
        <h2><?php echo $qaconfig['qa_title']?></h2>
    </div>
</section>
            ...
            <div id="bo_list">
                ...
                <div id="bo_btn_top">
                    ...
                    <ul class="btn_bo_user">
                        ...
                        <li>
                            ...
                            <div class="bo_sch_wrap">
                                <fieldset class="bo_sch">
                                    <h3>검색</h3>
                                    <legend class="screen_out">게시물 검색</legend>
                        ...
                        <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="문의등록"><i class="fa fa-pen" aria-hidden="true"></i><span class="sound_only">문의등록</span></a></li><?php } ?>
                    </ul>
                    <?php } ?>
                </div>
                <!-- } 게시판 페이지 정보 및 버튼 끝 -->
                ...
                <div class="bo_fx">
                    <ul class="btn_bo_user">
                        <?php if ($is_checkbox) { ?>
                        <li><button type="submit" name="btn_submit" value="선택삭제" title="선택삭제" onclick="document.pressed=this.value" class="btn btn_b01 btn_admin"><i class="fa fa-trash" aria-hidden="true"></i><span class="sound_only">선택삭제</span></button></li>
                        <?php } ?>
                        <?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b01 btn" title="문의등록"><i class="fa fa-pen" aria-hidden="true"></i><span class="sound_only">문의등록</span></a></li><?php } ?>
                    </ul>
                </div>
